...
class BootStrapService {
    ...
    List<User> createUsers() {
        ...
        User user
        2.times {
            user = new User(username: "kavita${it}", email: "kavita${it}@gmail.com ", password: "1234", firstName: "kavita $it", lastName: "bora", admin:true, active:true , photoPath: "kavita${it}.jpeg")
